...
Shader "Outside"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( texCUBE( _HDR_Outside, refract( -ase_worldViewDir , (WorldNormalVector( i , UnpackScaleNormal( tex2D( _Normal, uv_Normal ), _FrostScale ) )) , _Refraction ) ) * _Tint ) + ( _FrostTint * tex2D( _ColourMask, uv_ColourMask ).r ) ).rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18800
415;712;1224;675;1728.891;-31.72723;1;True;True
Node;AmplifyShaderEditor.RangedFloatNode;25;-1733.413,151.7609;Inherit;False;Property;_FrostScale;Frost Scale;6;0;Create;True;0;0;0;False;0;False;0;0.451;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;6;-1426.546,112.4167;Inherit;True;Property;_Normal;Normal;2;0;Create;True;0;0;0;False;0;False;-1;499524260bf3b5348a45d39b3cacdf20;f59ab00d45592c34e9fb92928135953d;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NegateNode;3;-727.4864,-8.186939;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-802.0906,197.8488;Inherit;False;Property;_Refraction;Refraction;3;0;Create;True;0;0;0;False;0;False;1;0.93;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldNormalVector;26;-1001.435,131.0177;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ColorNode;5;-184.5312,171.0759;Inherit;False;Property;_Tint;Tint;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.4099768,0.7830188,0.7499645,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;14;-223.7503,-519.0018;Inherit;False;Property;_FrostTint;Frost Tint;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.03003739,0.05637415,0.08490568,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;24;-556.6083,-310.0347;Inherit;True;Property;_ColourMask;Colour Mask;5;0;Create;True;0;0;0;False;0;False;-1;None;499524260bf3b5348a45d39b3cacdf20;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=C2343327AD62E7237E33EBAFAECC15352D21CEF5